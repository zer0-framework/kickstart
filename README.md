...
sudo apt install -y nginx php7.4-fpm php7.4-opcache php7.4-xml php7.4-igbinary php7.4-cli php7.4-yaml php7.4-mbstring php7.4-dev libevent-dev composer make pkg-config php7.4-curl php7.4-pgsql php-pear
